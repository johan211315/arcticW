      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="breadcrumb-tree">
            ...
            <li class="active">El libro de los 5 anillos</li>
          </ul>
        </div>
      </div>
      <!-- /row -->
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-5 col-md-push-2">
          <div id="product-main-img">
            <div class="product-preview">
              <img
                src="../img/Portadas/5anillos3.jpg"
                alt="100años-soledad"
                height="600px" />
            </div>

            <div class="product-preview">
              <img src="../img/Portadas/2.jpg" alt="" />
            </div>

            <div class="product-preview">
              <img src="../img/Portadas/5anillos1.jpg" alt="" />
            </div>

            <div class="product-preview">
              <img src="../img/Portadas/5anillos2.webp" alt="" />
            </div>
          </div>
        </div>
        <!-- /Product main img -->
        ...
        <div class="col-md-2 col-md-pull-5">
          <div id="product-imgs">
            <div class="product-preview">
              <img src="../img/Portadas/5anillos3.jpg" alt="pagina de prueba" />
            </div>

            <div class="product-preview">
              <img
                src="../img/Portadas/2.jpg"
                alt="pagina de prueba" />
            </div>

            <div class="product-preview">
              <img
                src="../img/Portadas/5anillos1.jpg"
                alt="pagina de prueba" />
            </div>

            <div class="product-preview">
              <img
                src="../img/Portadas/5anillos2.webp"
                alt="pagina de prueba" />
            </div>
          </div>
        </div>
        ...
        <form action="" method="post">
          <div class="col-md-5">
            <div class="product-details">
              <h2 class="product-name" name="nombre" value="El libro de los 5 anillos">
              ...
              <p>
                L'obra mestra de la filosofia samurai, per primer cop en edició íntegra i traduïda del japonès. Un clàssic imprescindible en format de luxe. El llibre dels cinc anells és un dels textos fonamentals del pensament marcial japonès. Escrit per Miyamoto Musashi al segle XVI com a manual per instruir els deixebles de la seva escola, aquesta obra va acabar convertint-se en la pedra angular de la filosofia dels samurais. Fent ús d'un estil senzill i clar, Musashi revela els secrets de la seva tècnica marcial, adquirida al llarg d'una vida consagrada a recórrer la Via del Guerrer, i desvetlla les claus espirituals, ètiques i psicològiques per transcendir la pràctica i assolir el buit. Els ensenyaments de «El llibre dels cinc anells», lluny de quedar obsoletes, continuen despertant interès en tots aquells que volen emprendre un camí de millora, lideratge i autoconeixement.
              </p>
              ...
              <div class="add-to-cart">
                ...
                <form action="" method="post">
                  <input type="hidden" name="nombre" id="nombre" value="El libro de los 5 anillos">
                  <input type="hidden" name="precio" id="precio" value="5.99">
          ...
          <div class="product">
            ...
            <div class="product-body">
              ...
              <h4 class="product-price">
                Є5.99 <del class="product-old-price">Є10.00 </del>
              </h4>
