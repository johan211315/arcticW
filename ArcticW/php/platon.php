      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="breadcrumb-tree">
            ...
            <li class="active">Platon la república</li>
          </ul>
        </div>
      </div>
      <!-- /row -->
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-5 col-md-push-2">
          <div id="product-main-img">
            <div class="product-preview">
              <img
                src="/ArcticW/img/Portadas/platon2.jpg"
                alt="100años-soledad"
                height="600px" />
            </div>

            <div class="product-preview">
              <img src="/ArcticW/img/Portadas/platon3.jpg" alt="falla" />
            </div>

            <div class="product-preview">
              <img src="/ArcticW/img/Portadas/platon4.webp" alt="falla2" />
            </div>

            <div class="product-preview">
              <img src="/ArcticW/img/Portadas/3.jpg" alt="falla3" />
            </div>
          </div>
        </div>
        <!-- /Product main img -->
        ...
        <div class="col-md-2 col-md-pull-5">
          <div id="product-imgs">
            <div class="product-preview">
              <img src="/ArcticW/img/Portadas/platon2.jpg" alt="pagina de prueba" />
            </div>

            <div class="product-preview">
              <img
                src="/ArcticW/img/Portadas/platon3.jpg"
                alt="pagina de prueba" />
            </div>

            <div class="product-preview">
              <img
                src="/ArcticW/img/Portadas/platon4.webp"
                alt="pagina de prueba" />
            </div>

            <div class="product-preview">
              <img
                src="/ArcticW/img/Portadas/3.jpg"
                alt="pagina de prueba" />
            </div>
          </div>
        </div>
        ...
        <form action="" method="post">
          <div class="col-md-5">
            <div class="product-details">
              <h2 class="product-name" name="nombre" value="Platón la República">
                Platón la República
              </h2>
              <div>
              ...
              <div>
                <h3 class="product-price" name="precio" value="11.00">
                  Є7.99 <del class="product-old-price">Є11.00</del>
                  <span style="font-size: 20px">-27%</span>
                </h3>
              </div>
              <p>
                La República és l'obra més coneguda de Plató i és un dels diàlegs més importants on expressa la seva concepció de l'art, la política, la societat, la justícia, la immortalitat, la virtut, el bé i el mal. És un diàleg entre Sòcrates i altres personatges. El propòsit de Plató és l'estudi del que és just i injust, i les demostracions de la necessitat moral, tant per a l'Estat com per a l'individu, de regir tota la seva conducta segons la justícia; això és, segons la virtut, o precisament més, segons la idea del bé, principi de bon ordre per a les societats i les ànimes. L?obra està composta per deu llibres.
              </p>
              ...
              <div class="add-to-cart">
                ...
                <form action="" method="post">
                  <input type="hidden" name="nombre" id="nombre" value="Platón la República">
                  <input type="hidden" name="precio" id="precio" value="7.99">
        ...
        <div class="col-md-3 col-xs-6">
          <div class="product">
            ...
            <div class="product-body">
              ...
              <h4 class="product-price">
                Є7.99 <del class="product-old-price">Є10.00</del>
              </h4>
              <div class="product-rating"></div>
            </div>
            <div class="add-to-cart">
