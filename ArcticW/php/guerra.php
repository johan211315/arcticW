      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="breadcrumb-tree">
            ...
            <li class="active">El arte de la guerra</li>
          </ul>
        </div>
      </div>
      <!-- /row -->
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-5 col-md-push-2">
          <div id="product-main-img">
            <div class="product-preview">
              <img
                src="/ArcticW/img/Portadas/4.jpg"
                alt=" 100años-soledad"
                height="600px" />
            </div>

            <div class="product-preview">
              <img src="/ArcticW/img/Portadas/guerra3.jpg" alt="fallo2" />
            </div>

            <div class="product-preview">
              <img src="/ArcticW/img/Portadas/guerra4.webp" alt="fallo3" />
            </div>

            <div class="product-preview">
              <img src="/ArcticW/img/Portadas/guerra5.jpg" alt="fallo4" />
            </div>
          </div>
        </div>
        <!-- /Product main img -->
        ...
        <div class="col-md-2 col-md-pull-5">
          <div id="product-imgs">
            <div class="product-preview">
              <img src="/ArcticW/img/Portadas/4.jpg" alt="pagina de prueba" />
            </div>

            <div class="product-preview">
              <img
                src="/ArcticW/img/Portadas/guerra3.jpg"
                alt="pagina de prueba" />
            </div>

            <div class="product-preview">
              <img
                src="/ArcticW/img/Portadas/guerra4.webp"
                alt="pagina de prueba" />
            </div>

            <div class="product-preview">
              <img
                src="/ArcticW/img/Portadas/guerra5.jpg"
                alt="pagina de prueba" />
            </div>
          </div>
        </div>
            ...
            <div class="product-details">
              ...
              <div>
                <h3 class="product-price" name="precio" value="11.00">
                  Є8.99 <del class="product-old-price">Є11.00</del>
              ...
              <div class="product-options">
                <label>
                  ...
                  <select class="input-select">
                    ...
                    <option name="tipo" value="Ebook">Ebook</option>
                  </select>
                </label>
              </div>
              ...
              <div class="add-to-cart">
                ...
                <form action="" method="post">
                  <input type="hidden" name="nombre" id="nombre" value="El arte de la Guerra">
                  <input type="hidden" name="precio" id="precio" value="8.99">
